...
$.fn.extend({
    lightSlider: function (options) {
        ...
        var $children = $el.children(), windowW = $(window).width(), breakpoint = null, resposiveObj = null, length = 0, w = 0, on = false, elSize = 0, $slide = '', scene = 0, gutter = (settings.vertical === true) ? 'margin-bottom' : 'margin-right', slideValue = 0, pagerWidth = 0, slideWidth = 0, thumbWidth = 0, interval = null;
        ...
        plugin = {
            doCss: function () {
                var support = function () {
                    var transition = ['transition', 'MozTransition', 'WebkitTransition',
            ...
            enableDrag: function () {
                var $this = this;
                if (!isTouch) {
                    var startCoords_1 = 0, endCoords_1 = 0, isDraging_1 = false;
