 ...
 * @param isShowSuccessMsg 是否顯示回應成功訊息
 */
function BasePostAPI(loadingMsg, api, model, successFunc, errorFunc, isNotification, isShowSuccessMsg) {
    if (isNotification === void 0) { isNotification = false; }
    if (isShowSuccessMsg === void 0) { isShowSuccessMsg = true; }
    return new Promise(function (resolve, reject) {
        if (loadingMsg)
 ...
 * @param isShowSuccessMsg 是否顯示回應成功訊息
 */
function BasePostAPIWithVoid(loadingMsg, api, model, successFunc, errorFunc, isNotification, isShowSuccessMsg) {
    if (isNotification === void 0) { isNotification = false; }
    if (isShowSuccessMsg === void 0) { isShowSuccessMsg = true; }
    if (loadingMsg)
        Common.SweetAlertLoading(loadingMsg);
...
function LoginAPI(loadingMsg, model, successFunc, errorFunc) {
    BasePostAPIWithVoid(loadingMsg, "/MemberApi/Login", model, successFunc, errorFunc);
}
/**
 * Google 第三方登入 API
 */
function GoogleLoginAPI(loadingMsg, model, successFunc, errorFunc) {
    BasePostAPIWithVoid(loadingMsg, "/MemberApi/GoogleLogin", model, successFunc, errorFunc);
}
/**
 * 寄送驗證碼 API
 */
function SendVCodeAPI(loadingMsg, model, successFunc, errorFunc) {
    BasePostAPIWithVoid(loadingMsg, "/MemberApi/SendVCode", model, successFunc, errorFunc);
}
/**
 * 註冊 API
 */
function SignupAPI(loadingMsg, model, successFunc, errorFunc) {
    BasePostAPIWithVoid(loadingMsg, "/MemberApi/Signup", model, successFunc, errorFunc);
}
/**
 * 更新會員公開資訊 API
 */
function UpdateMemberPublicInfoAPI(loadingMsg, model, successFunc, errorFunc) {
    BasePostAPIWithVoid(loadingMsg, "/MemberApi/UpdateMemberPublicInfo", model, successFunc, errorFunc);
}
/**
 * 重設密碼 Step1 API
 * 申請重設密碼、建立重設密碼URL
...
function ResetPasswordAPI(loadingMsg, model, successFunc, errorFunc) {
    BasePostAPIWithVoid(loadingMsg, "/MemberApi/ResetPassword", model, successFunc, errorFunc);
}
/**
 * 重設密碼 Step2 API
 */
function ResetPasswordConfirmAPI(loadingMsg, model, successFunc, errorFunc) {
    BasePostAPIWithVoid(loadingMsg, "/MemberApi/ResetPasswordConfirm", model, successFunc, errorFunc);
}
/**
 * 登出 API
 */
 ...
 * 取得會員資訊 API
 */
function GetMemberInfoAPI(memberID, successFunc, errorFunc) {
    return __awaiter(this, void 0, void 0, function () {
        var isNotification, isShowSuccessMsg;
        return __generator(this, function (_a) {
            switch (_a.label) {
