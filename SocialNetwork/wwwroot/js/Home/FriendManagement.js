...
var FriendManagementPage = {
    ...
    FriendInvitationHtmlTemplate: function (member) {
        return "\n<div class=\"div_friend_profile\">\n    <a href=\"/Home/HomePage/".concat(member.MemberID, "\" target=\"_blank\">\n        <img class=\"div_friend_img\" src=\"").concat(member.ProfilePhotoURL, "\">\n    </a>\n    <div class=\"div_friend_name_content\">\n        <a class=\"div_friend_name\" href=\"/Home/HomePage/").concat(member.MemberID, "\" target=\"_blank\">").concat(member.NickName, "</a>\n    </div>\n    <input class=\"div_frient_button_pink\" type=\"button\" value=\"\u63A5\u53D7\" onclick=\"Friend.DecideFriendInvitation(").concat(member.MemberID, ", '").concat(member.NickName, "', ").concat(DecideFriendInvitationEnum.接受, ", () => FriendManagementPage.ToggleTab('FriendInvitation'))\"/>\n    <input class=\"div_frient_button_gray\" type=\"button\" value=\"\u62D2\u7D55\" onclick=\"Friend.DecideFriendInvitation(").concat(member.MemberID, ", '").concat(member.NickName, "', ").concat(DecideFriendInvitationEnum.拒絕, ", () => FriendManagementPage.ToggleTab('FriendInvitation'))\"/>\n</div>\n  ");
    },
    /**
    ...
    SendFriendInvitationHtmlTemplate: function (member) {
        return "\n<div class=\"div_friend_profile\" style=\"height: 360px;\">\n    <a href=\"/Home/HomePage/".concat(member.MemberID, "\" target=\"_blank\">\n        <img class=\"div_friend_img\" src=\"").concat(member.ProfilePhotoURL, "\">\n    </a>\n    <div class=\"div_friend_name_content\">\n        <a class=\"div_friend_name\" href=\"/Home/HomePage/").concat(member.MemberID, "\" target=\"_blank\">").concat(member.NickName, "</a>\n    </div>\n    <input class=\"div_frient_button_gray\" type=\"button\" value=\"\u6536\u56DE\u9080\u8ACB\" onclick=\"Friend.RevokeFriendInvitation(").concat(member.MemberID, ", '").concat(member.NickName, "', () => FriendManagementPage.ToggleTab('SendFriendInvitation'))\"/>\n</div>\n  ");
    }
};
